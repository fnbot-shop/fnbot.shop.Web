...
namespace fnbot.shop.Web
{
    ...
    public class Client : IDisposable
    {
        ...
        protected virtual async Task<Response> SendInternalAsync(HttpRequestMessage request, IReadOnlyDictionary<string, string> reqHeaders = null, bool addBody = true)
        {
            if (reqHeaders != null)
            {
